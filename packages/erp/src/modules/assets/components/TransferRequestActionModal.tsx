...
const ACTION_CFG: Record<TransferAction, {
  ...
  handover: {
    ...
    warning: 'Sau khi xác nhận, tài sản chuyển sang IN_USE và được ghi vào assignedPersonId. Không thể hoàn tác trực tiếp — phải qua flow Thu hồi.',
    icon: PackageCheck,
  ...
  cancel: {
    title: 'Huỷ yêu cầu',
    confirmLabel: 'Huỷ ticket',
    placeholder: '',
    warning: 'Chỉ có thể huỷ khi ticket còn ở trạng thái Chờ duyệt. Sau khi huỷ, phải tạo ticket mới nếu muốn cấp phát lại.',
    icon: XCircle,
