...
export type QlnsHubTabDef<T extends string> = {
  key: T
  label: string
  icon: LucideIcon
  hint?: string
...
type QlnsHubLayoutProps<T extends string> = {
  title: string
  description: string
  tabs: QlnsHubTabDef<T>[]
  tab: T
  visibleTabKeys: T[]
  defaultTab: T
  syncKey?: unknown
...
export function QlnsHubLayout<T extends string>({
  title,
  description,
  tabs,
  tab,
