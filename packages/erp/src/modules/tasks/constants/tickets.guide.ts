  ...
  sections: [
      ...
      steps: [
        {
          ...
          description:
            'Chọn danh mục (Bug / Feature / Hỗ trợ), độ ưu tiên và người thực hiện. Đặt hạn (dueDate) để theo dõi deadline.',
        },
        {
    ...
    },
    {
      ...
      tips: [
        ...
        'Màu nền card theo danh mục (Bug / Feature / Hỗ trợ) — soft pastel token, không đổi nghiệp vụ.',
    ...
    },
    {
      ...
      notes:
        'Nền + viền trái map theo category (Bug → danger, Feature → info, Hỗ trợ → primary…). Badge priority: URGENT đỏ / HIGH cam / MEDIUM xanh dương / LOW xám. Tiến độ bar map từ status cho đến khi BE có progressPercent / checklist. Attachment count chỉ hiện khi BE trả attachmentCount.',
    },
  ],
}
