...
| **Mua hàng / Kế toán** | Theo dõi phiếu nhập sau đơn mua hàng, nhập **số HĐ NCC**, duyệt trước nhập kho |
...
1. **Cảnh báo tồn** → **Yêu cầu mua hàng** (PR) → duyệt ở Hộp thư.
2. Tạo **Đơn mua hàng** (PO) khi cần.
3. Hàng về → **Phiếu nhập kho**: nháp → (tuỳ quy mô) **Gửi duyệt → Duyệt** → nhập **số HĐ NCC** nếu gắn đơn mua/NCC → **Xác nhận nhập** → tồn tăng.

> Phiếu gắn **đơn mua hàng hoặc NCC** bắt buộc có **số hóa đơn GTGT đầu vào** trước khi xác nhận nhập (theo chuẩn SAP/AMIS).
...
4. Nhập **số HĐ NCC** và ngày HĐ nếu phiếu gắn đơn mua/NCC.
...
1. **Cảnh báo tồn** → **Yêu cầu mua hàng** → duyệt ở Hộp thư.
2. Tạo **Đơn mua hàng** khi cần.
3. **Phiếu nhập xác nhận** → tồn tăng.

Duyệt yêu cầu mua **không** tự nhập kho — xem [Quy tắc tái nhập kho](/docs/guide-warehouse-reorder-rules).
...
| Phiếu nhập từ đơn mua không cần HĐ NCC | **Sai** — phải có số HĐ trước khi xác nhận nhập |
