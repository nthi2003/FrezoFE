// ============================================================
// FREZO ERP — MultiSelect Component
// Premium dropdown selection with tags, search filter, select all, and clean animations
// ============================================================
...
export function MultiSelect({
  ...
  const handleSelectAll = (e: React.MouseEvent) => {
    ...
    // Merge existing selected with new ones, avoiding duplicates
  ...
  const handleClearAll = (e: React.MouseEvent) => {
    e.stopPropagation()
    // Clear only the currently filtered options from selection
